...
const registryTool = process.env.RESEARCH_REGISTRY_TOOL;
if (registryTool) {
  if (!existsSync(registryTool)) throw new Error('Configured research register exporter was not found');
